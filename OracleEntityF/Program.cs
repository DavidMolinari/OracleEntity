        ...
        static void Main(string[] args)
        {
            using (OracleEntities oracleContexte = new OracleEntities())
            {
                ...
                var requeteEmployesById = from EMPLOYE in oracleContexte.EMPLOYEs
                                          ...
                                          select EMPLOYE;
                var empplyeId = requeteEmployesById.FirstOrDefault();
                if (empplyeId != null)
                {
                    Console.WriteLine(empplyeId.NOMEMP + " - " + empplyeId.PRENOMEMP + " - " + empplyeId.SALAIRE);

                }
                else Console.WriteLine("L'employé : " + idEmploye + " n'existe pas");
